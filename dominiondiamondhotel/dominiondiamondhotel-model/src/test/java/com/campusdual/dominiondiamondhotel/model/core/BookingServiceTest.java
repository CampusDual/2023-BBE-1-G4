...
public class BookingServiceTest {
    ...
    class BookingServiceForecast {
        ...
        void testForecast() throws IOException {
            ...
            HttpEntity responseKeyEntity = new HttpEntityWrapper(new ByteArrayEntity(keyValue.getBytes(StandardCharsets.UTF_8)));
            HttpEntity responseForecastEntity = new HttpEntityWrapper(new ByteArrayEntity(forecastValue.getBytes(StandardCharsets.UTF_8)));
            ...
            when(response.getStatusLine()).thenReturn(new BasicStatusLine(HttpVersion.HTTP_1_1, HttpStatus.SC_OK, "TEST OK!"));
            when(response.getEntity()).thenReturn(responseKeyEntity, responseForecastEntity);
